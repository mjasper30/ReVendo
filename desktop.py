...
def tutorial_page():
    ...
    tutorial_steps = tk.Label(
        app, text="Step 1: \nTap your card on the reader \n\n Step 2: \nInsert your plastic bottles inside the machine \n\n Step 3: \nCheck your points \n\n Step 4: \nOnce done, get your card and proceed to \ncharging station", font=("Arial", 18), bg='white')
...
def menu():
    ...
    get_points_button.place(
        relx=0.3, rely=0.6, anchor='center', width=130, height=40)
    ...
    check_balance_button.place(
        relx=0.7, rely=0.6, anchor='center', width=160, height=40)
